...
public class AccountController {
    ...
    public Long createAccount(@RequestBody AccountRequestDTO accountRequestDTO) {
        return accountService.create(accountRequestDTO.getName(), accountRequestDTO.getEmail(),
    ...
    public AccountResponseDTO updateAccount(@PathVariable Long accountId,
        ...
        return new AccountResponseDTO(accountService.update(accountId, accountRequestDTO.getName(), accountRequestDTO.getEmail(),
                accountRequestDTO.getPhone(), accountRequestDTO.getBills()));
    }
